...
###### the 3 variables f.pos_imm + f.gender + f.ostwest are redundant, they appear at the beginning of the model and at the end######
summary(mn12)
mn13 <- step(mn12)
summary(mn13)
anova(mn12,mn13)
...
As we can see the we get a coefieicient of 0.938 for the open level and -1.13 for the restrictive level of pos_imm. Female h as a coefficient of 0.33 and finally, for each political_interest variable there are coefficient values around 3.
...
As we can see in the model follows a similar behavior as the nominal model: restrictive about immigration and less political interest are more likely to vote for rights and on the other hand, open and high political_interest are more likely to vote for left and so on.
...
#### Missings: f.ostwest ####
#### appear twice: f.pos_imm+f.ostwest ####
summary(mh3)
mh4 <- step(mh3)
summary(mh4)
#comparision
...
#### Missings: political_interest*f.pos_imm, f.ostwest*f.gender ####
summary(mh7)
mh8 <- step(mh7)
summary(mh8)
AIC(mh8,mh7)
